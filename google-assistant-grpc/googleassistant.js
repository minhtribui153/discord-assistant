...
const config = require('../src/credentials/config.json')
...
console.log(embedded_assistant_pb);
...
class GoogleAssistant {
    constructor(credentials) {
        ...
        this.locale = "en-US";
        this.deviceModelId = config.device.modelId;
        this.deviceInstanceId = config.device.id;
    }
...
const deviceCredentials = require(`../src/credentials/credentials.json`);
